            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="our-link">
                    <ul>
                        ...
                        <li><a href="{{ route('cart') }}"><i class="fa fa-cart-plus"></i> Cart</a></li>
                        <li><a href="{{ route('customer.account') }}"><i class="fa fa-user"></i> Account</a></li>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('index') }}"><img
                        src="{{ asset('wayshop/assets/images/')}}/logo.png" class="logo" alt=""></a>
            </div>
        ...
        <div class="side">
            ...
            <li class="cart-box">
                <ul class="cart-list">
                    <li>
                        <a href="#" class="photo"><img src="{{ asset('wayshop/assets/images/')}}/img-pro-01.jpg"
                                class="cart-thumb" alt="" /></a>
                        <h6><a href="#">Delica omtantur </a></h6>
                        <p>1x - <span class="price">$80.00</span></p>
                    </li>
                    <li>
                        <a href="#" class="photo"><img src="{{ asset('wayshop/assets/images/')}}/img-pro-02.jpg"
                                class="cart-thumb" alt="" /></a>
                        <h6><a href="#">Omnes ocurreret</a></h6>
                        <p>1x - <span class="price">$60.00</span></p>
                    </li>
                    <li>
                        <a href="#" class="photo"><img src="{{ asset('wayshop/assets/images/')}}/img-pro-03.jpg"
                                class="cart-thumb" alt="" /></a>
