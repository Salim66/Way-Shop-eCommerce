                            ...
                            <ul class="menu">
                                <li>
                                    ...
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="{{ asset('admin/assets/')}}//dist/img/basketball-jersey.png"
                                ...
                                <li>
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="{{ asset('admin/assets/')}}//dist/img/shirt.png"
                                                class="img-thumbnail" alt="User Image">
                                        </div>
                                        <h4>Kits</h4>
                                ...
                                <li>
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="{{ asset('admin/assets/')}}//dist/img/football.png"
                                                class="img-thumbnail" alt="User Image">
                                        </div>
                                        <h4>Football</h4>
                                ...
                                <li class="nav-list">
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="{{ asset('admin/assets/')}}//dist/img/shoe.png"
                                                class="img-thumbnail" alt="User Image">
                                        </div>
                                        <h4>Sports sheos</h4>
                        ...
                        <li>
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="{{ asset('admin/assets/')}}//dist/img/avatar2.png"
                                                class="img-circle" alt="User Image">
                                        </div>
                                        <h4>Leo messi</h4>
                                ...
                                <li>
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="{{ asset('admin/assets/')}}//dist/img/avatar3.png"
                                                class="img-circle" alt="User Image">
                                        </div>
                                        <h4>Modric</h4>
                                ...
                                <li>
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="{{ asset('admin/assets/')}}//dist/img/avatar4.png"
                                                class="img-circle" alt="User Image">
                                        </div>
                                        <h4>Salman</h4>
