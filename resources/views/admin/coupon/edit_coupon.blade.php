            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <form action="{{ route('coupons.update', $data->id) }}" method="POST" class="col-sm-12"
                            id="couponEditForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <select name="amount_type" id="amount_type" class="form-control">
                                    ...
                                    <option value="Percentange"
                                        {{ ($data->amount_type == 'Percentage')? 'selected' : '' }}>Percentage</option>
                                    <option value="Fixed" {{ ($data->amount_type == 'Fixed')? 'selected' : '' }}>
                                        Fixed
                                    </option>
                                </select>
                                <span
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" name="expiry_date" class="form-control" id="datepicker"
                                    autocomplete="off" value="{{ $data->expiry_date }}">
                                <span
